package com.app.fringale.Activities.CurrentlocActivity
...
class CurrentlocActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val value = ai.metaData["AIzaSyBJWyb9DIOOi9_Bx9MrSiRhNDtszhZqPD0"]
