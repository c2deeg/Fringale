...
class FoodCategoriesRecyclerAdapter (fragmentActivity: FragmentActivity) : RecyclerView.Adapter<FoodCategoriesRecyclerAdapter.ViewHolder>() {


    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): FoodCategoriesRecyclerAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.foodcategoriesrecyleritem, parent, false)
        return FoodCategoriesRecyclerAdapter.ViewHolder(view)
    }
