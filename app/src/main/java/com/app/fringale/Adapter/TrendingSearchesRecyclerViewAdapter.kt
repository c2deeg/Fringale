...
class TrendingSearchesRecyclerViewAdapter (fragmentActivity: FragmentActivity) : RecyclerView.Adapter<TrendingSearchesRecyclerViewAdapter.ViewHolder>() {


    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TrendingSearchesRecyclerViewAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.trendingsearchesrecycleritem, parent, false)
        return TrendingSearchesRecyclerViewAdapter.ViewHolder(view)
    }
