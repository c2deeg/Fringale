...
class PopularCuisinesRecyclerAdapter  (fragmentActivity: FragmentActivity) : RecyclerView.Adapter<PopularCuisinesRecyclerAdapter.ViewHolder>() {


    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): PopularCuisinesRecyclerAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.popularitemsinstamartrecycleradapter, parent, false)
        return PopularCuisinesRecyclerAdapter.ViewHolder(view)
    }
