...
class ViewSearchRecyclerAdapter (fragmentActivity: FragmentActivity) : RecyclerView.Adapter<ViewSearchRecyclerAdapter.ViewHolder>() {


    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ViewSearchRecyclerAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.searchviewrecycleritem, parent, false)
        return ViewSearchRecyclerAdapter.ViewHolder(view)
    }
